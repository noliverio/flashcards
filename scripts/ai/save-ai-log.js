...
function usage(){
  console.log('Usage: save-ai-log.js --issue <id> [--title <title>] [--prompt-file <path>] [--transcript-file <path>] [--diff-file <path>] [--files-changed-file <path>] [--commit <sha>] [--outdir <dir>] [--force]')
}
...
function readMaybe(filePath){
  ...
  catch(e){ console.warn(`Warning: cannot read ${filePath}: ${e.message}`); return '' }
}
